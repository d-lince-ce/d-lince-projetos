# d-lince-projetos
Projetos desenvolvidos na Divisão de Suporte de Sistemas Educacionais e Redes Digitais
O construtor de tutoriais é um projeto desenvolvido para auxiliar o D-LINCE a planejar e documentar os padrões de formatação (W11 e Linux) no Centro de Educação (UFSM) - prédio 16
...
6) As seções são cambiáveis, clique e arraste para alterar a ordem

**OBS: É necessário editar a capa após exportar o arquivo .docx**
